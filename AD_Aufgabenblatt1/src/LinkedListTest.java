...
public class LinkedListTest
{
    ...
    public void testeFuegeEin()
    {
        ...
        System.out.println("LinkedList Zeit am Anfang einfügen: " + anfang/10 + " Millisekunden");
    	System.out.println("LinkedList Zeit zufällig einfügen: " + zufall/10 + " Millisekunden");
    	System.out.println("LinkedList Zeit am Ende einfügen: " + ende/10 + " Millisekunden");
    	System.out.println();
    }
    ...
    public void testeLoesche()
    {
    	...
    	System.out.println("LinkedList Zeit am Anfang löschen: " + anfang/10 + " Millisekunden");
    	System.out.println("LinkedList Zeit zufällig löschen: " + zufall/10 + " Millisekunden");
    	System.out.println("LinkedList Zeit am Ende löschen: " + ende/10 + " Millisekunden");
    	System.out.println();
    }
